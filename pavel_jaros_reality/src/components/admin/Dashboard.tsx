...
// ═══════════════════════════════════════════════════════════════════════════
// PJ REALITY DASHBOARD - Standalone for Reality website ONLY
// ═══════════════════════════════════════════════════════════════════════════
  ...
  const contentSections = [
    {
      ...
      fields: [
        ...
        { key: 'hero.cta', label: 'CTA tlačítko', value: siteData.sections.hero.cta },
      ]
    },
    {
      id: 'services',
    ...
    },
    {
      ...
      fields: [
        { key: 'about.name', label: 'Jméno', value: siteData.sections.about.name },
        { key: 'about.intro', label: 'Úvod', value: siteData.sections.about.intro },
        { key: 'about.origin', label: 'Původ', value: siteData.sections.about.origin },
        { key: 'about.motivation', label: 'Motivace', value: siteData.sections.about.motivation },
      ]
    },
    {
      id: 'references',
      title: 'Reference',
      icon: Star,
      description: `${siteData.sections.references.length} reference klientů`,
      fields: siteData.sections.references.flatMap((ref, index) => [
        { key: `references.${index}.name`, label: `Klient ${index + 1} - Jméno`, value: ref.name },
        { key: `references.${index}.text`, label: `Klient ${index + 1} - Text`, value: ref.text },
      ])
    },
    {
      id: 'contact',
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white">PJ Reality</h1>
              <p className="text-gray-400">Správa webu Reality</p>
            </div>
          </div>
        </div>
      ...
      >
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            ...
            style={{ background: `${SITE_COLOR}20`, color: SITE_COLOR }}
          >
            Spravovat média
          </button>
        </div>
            ...
            >
              <div className="aspect-video bg-black/30 flex items-center justify-center p-4">
                <img
                  ...
                  onError={(e) => {
                    e.currentTarget.src = 'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100"><rect fill="%23333" width="100" height="100"/><text fill="%23666" x="50%" y="50%" text-anchor="middle" dy=".3em">No Image</text></svg>';
                  }}
                />
              </div>
              <div className="p-3">
                ...
                <span
                  ...
                  style={{
                    background: image.category === 'logo' ? `${SITE_COLOR}20` : '#3B82F620',
                    color: image.category === 'logo' ? SITE_COLOR : '#3B82F6',
                  }}
                >
                  {image.category}
                </span>
        ...
        {contentSections.map((section) => {
          ...
          return (
            <div
              ...
              style={{
                background: theme.bg.secondary,
                border: `1px solid ${isExpanded ? SITE_COLOR + '50' : theme.border.subtle}`,
              }}
            >
              {/* Section Header */}
              <button
                ...
                style={{
                  background: isExpanded ? `${SITE_COLOR}10` : 'transparent',
                }}
              >
                <div className="flex items-center gap-4">
                  <div
                    className="w-10 h-10 rounded-lg flex items-center justify-center"
                    style={{ background: `${SITE_COLOR}20` }}
                  >
                        ...
                        <div className="flex items-start justify-between gap-4">
                          ...
                          {!isEditing && (
                            <button
                              ...
                              onMouseEnter={(e) => {
                                e.currentTarget.style.background = `${SITE_COLOR}20`;
                                e.currentTarget.style.color = SITE_COLOR;
                              }}
                              onMouseLeave={(e) => {
      ...
      <div
        className="rounded-xl p-6"
        style={{
          background: `linear-gradient(135deg, ${SITE_COLOR}15 0%, ${SITE_COLOR}05 100%)`,
      ...
      >
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-400">Spravujte obsah webu PJ Reality</p>
          </div>
          ...
          <div>
            {[
              ...
              <div
                key={index}
                className="px-6 py-4 flex items-center justify-between"
                style={{ borderBottom: index < 2 ? `1px solid ${theme.border.subtle}` : undefined }}
              >
                <div className="flex items-center gap-3">
                  <div
                    className="w-2 h-2 rounded-full"
                    style={{
                      background: item.type === 'update' ? '#22C55E' : item.type === 'upload' ? '#3B82F6' : SITE_COLOR
                    }}
                  />
          ...
          <div>
            {[
              ...
              <div
                key={index}
                className="px-6 py-4 flex items-center justify-between"
                style={{ borderBottom: index < 3 ? `1px solid ${theme.border.subtle}` : undefined }}
              >
