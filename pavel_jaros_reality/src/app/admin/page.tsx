        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                { label: 'Celkem sekcí', value: '8', icon: FileText, color: '#ef4444', change: '+2' },
                { label: 'Obrázky', value: sampleImages.length.toString(), icon: ImageIcon, color: '#3b82f6', change: '+5' },
                { label: 'Jazyky', value: '6', icon: Globe, color: '#22c55e', change: '0' },
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <div className="bg-[#141414] rounded-xl border border-white/10 overflow-hidden">
                ...
                <div className="divide-y divide-white/5">
                  {[
                    ...
                    { action: 'Aktualizace kontaktních údajů', time: 'Včera' },
              ...
              <div className="bg-[#141414] rounded-xl border border-white/10 overflow-hidden">
                ...
                <div className="divide-y divide-white/5">
                  {[
                    { label: 'Web', value: 'Pavel Jaroš Reality' },
