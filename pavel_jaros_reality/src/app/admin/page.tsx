              ...
              <div className="space-y-4">
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  <p className="text-yellow-800">
                    Pro změnu nastavení webu upravte soubory v projektu:
                  </p>
                  <ul className="list-disc list-inside mt-2 text-sm text-yellow-700">
                    <li><code>next.config.mjs</code> - konfigurace Next.js</li>
                    <li><code>tailwind.config.ts</code> - konfigurace Tailwind</li>
                    <li><code>messages/*.json</code> - překlady</li>
                  </ul>
                </div>
              </div>
            </CardContent>
