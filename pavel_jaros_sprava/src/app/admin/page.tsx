...
const csTranslations = {
  ...
  hero: {
    ...
    subtitle: "Komplexní správa bytových domů a komerčních objektů.",
  ...
  services: {
    ...
    technical: {
      ...
      text: "Údržba a opravy společných prostor a technických zařízení."
    },
    economic: {
      title: "Ekonomická správa",
      text: "Vedení účetnictví, rozpočty a vyúčtování služeb."
    }
  }
};
...
const sampleImages = [
  ...
  { path: '/images/PavelSpravaBezPozadi.png', name: 'Pavel Správa', type: 'local' as const, category: 'images' },
];
...
const contentSections = [
  {
    ...
    fields: [
      ...
      { key: 'hero.subtitle', label: 'Podnadpis', type: 'textarea' as const, value: 'Komplexní správa bytových domů a komerčních objektů.' },
      { key: 'hero.ctaPrimary', label: 'Primární tlačítko', type: 'text' as const, value: 'Kontaktujte nás' },
    ]
  },
  {
    id: 'services',
    ...
    fields: [
      ...
      { key: 'services.technical.title', label: 'Technická - nadpis', type: 'text' as const, value: 'Technická správa' },
      { key: 'services.technical.text', label: 'Technická - popis', type: 'textarea' as const, value: 'Údržba a opravy společných prostor a technických zařízení.' },
    ]
  },
  {
    id: 'about',
    ...
    fields: [
      { key: 'about.title', label: 'Nadpis', type: 'text' as const, value: 'O naší společnosti' },
      { key: 'about.text', label: 'Text', type: 'textarea' as const, value: 'Jsme profesionální tým správců nemovitostí...' },
    ]
  },
  {
    id: 'contact',
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                { label: 'Spravované objekty', value: '45', icon: Building, color: '#22c55e', change: '+12' },
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <div className="bg-[#141414] rounded-xl border border-white/10 overflow-hidden">
                ...
                <div className="divide-y divide-white/5">
                  {[
                    { action: 'Aktualizace seznamu objektů', time: 'Před 1 hodinou' },
                    { action: 'Změna kontaktních údajů', time: 'Před 4 hodinami' },
                    { action: 'Nahrání nové fotografie', time: 'Včera' },
                    { action: 'Úprava služeb', time: 'Před 3 dny' },
                  ].map((item, i) => (
              ...
              <div className="bg-[#141414] rounded-xl border border-white/10 overflow-hidden">
                ...
                <div className="divide-y divide-white/5">
                  {[
                    { label: 'Web', value: 'Pavel Jaroš Správa' },
